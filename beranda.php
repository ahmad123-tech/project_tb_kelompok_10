    ...
    <div class="container">
        <nav id="menu" class="hidden">
            <ul>
                ...
                <li><a href="transaksi.php"><i class="fas fa-shopping-cart"></i>Order </a></li>
                <li><a href="nota.php"><i class="fas fa-receipt"></i>Nota Pembayaran</a></li>
            </ul>
            <div class="logout">
